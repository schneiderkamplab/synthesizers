...
class SynthEvalAdapter(Adapter):
    def __init__(self, input_formats=(DataFrame,), config: str = 'full', target_col: str = None):
    ...
    def evaluate_generated(self, original_data, generated_data, config: str = 'full', target_col: str = None):
